...
\coordinate (V2_1) at (4, -4.440892098500626e-16);
\coordinate (V3_1) at (1.25, 2.904737509655563);
\coordinate (V3_2) at (5.000000000000001, 3.872983346207416);
\coordinate (V4_1) at (4.749999999999999, -2.904737509655563);
\coordinate (V5_1) at (2, 0);
\coordinate (V6_1) at (-1.75, -0.9682458365518543);
\coordinate (V6_2) at (5.75, 0.9682458365518533);
\coordinate (V7_1) at (-0.75, 2.904737509655563);
\coordinate (V7_2) at (6.750000000000001, 4.841229182759269);
\coordinate (V8_1) at (2.75, -2.904737509655563);
\coordinate (V8_2) at (-1, -3.872983346207417);
\coordinate (V8_3) at (2.749999999999999, -2.904737509655563);
\coordinate (V8_4) at (6.499999999999999, -1.93649167310371);
...
\node (F5) at (2.416666666666667, 0.9682458365518541) {$f_{5}$};
\fill[lightgray] (V2_1) -- (V3_2) -- (V6_2) -- cycle;
\node (F6) at (4.916666666666666, 1.613743060919756) {$f_{6}$};
\fill[white] (V2_1) -- (V4_1) -- (V5_1) -- cycle;
\node (F7) at (3.583333333333333, -0.9682458365518546) {$f_{7}$};
\fill[lightgray] (V2_1) -- (V4_1) -- (V6_2) -- cycle;
\node (F8) at (4.833333333333333, -0.6454972243679036) {$f_{8}$};
\fill[white] (V3_1) -- (V5_1) -- (V7_1) -- cycle;
\node (F9) at (0.8333333333333333, 1.936491673103709) {$f_{9}$};
\fill[lightgray] (V3_2) -- (V6_2) -- (V7_2) -- cycle;
\node (F10) at (5.833333333333333, 3.227486121839513) {$f_{10}$};
\fill[white] (V4_1) -- (V5_1) -- (V8_3) -- cycle;
\node (F11) at (3.166666666666666, -1.936491673103709) {$f_{11}$};
\fill[lightgray] (V4_1) -- (V6_2) -- (V8_4) -- cycle;
\node (F12) at (5.666666666666666, -1.290994448735807) {$f_{12}$};
...
\draw[ EdgeStyle, double=green] (V2_1) -- node { $e_{5}$ } (V3_2);
\draw[ EdgeStyle, double=blue] (V2_1) -- node { $e_{6}$ } (V4_1);
\draw[ EdgeStyle, double=red] (V2_1) -- node { $e_{7}$ } (V5_1);
...
\draw[ EdgeStyle, double=green] (V4_1) -- node { $e_{12}$ } (V5_1);
\draw[ EdgeStyle, double=green] (V6_2) -- node { $e_{13}$ } (V4_1);
\draw[ EdgeStyle, double=red] (V4_1) -- node { $e_{14}$ } (V8_3);
\draw[ EdgeStyle, double=red] (V8_4) -- node { $e_{14}$ } (V4_1);
