        ...
        \begin{center}
            ...
            \only<11-13|handout:1>{
                \begin{tikzpicture}
                    ...
                    \draw (A) -- (B) -- (C) -- (D) -- cycle;
                    \uncover<11>{
                        \draw[red] (A) -- (60:\fak*\len);
                        \draw[blue] (B) -- ($(B)+(120:\fak*\len)$);
                    }

                    \draw[<->] ($(A)!0.5!(D)$) to[bend right] ($(D)!0.5!(C)$);

                    \uncover<12|handout:0>{
                        \draw[red] (A) -- (5:\fak*\len);
                        \draw[blue] (B) -- ($(B)+(160:\fak*\len)$);
                    }

                    \uncover<13|handout:0>{
                        \draw[red] (A) -- (20:\fak*\len);
                        \draw[blue] (B) -- ($(B)+(175:\fak*\len)$);
                    }
                \end{tikzpicture}
            }
            % 11: general picture
...
\begin{frame}{Limitation of unordered folding}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[\colB,\wid] (0,0) -- (0,\len);
            \node[\colB] at (0,\nOff) {A};

            \draw[\colA,\wid] (\xOff,0) -- (\xOff,\len);
            \node[\colA] at (\xOff,\nOff) {B};
            ...
            \begin{scope}[xshift=4cm]
                ...
                \draw[\colA,\wid] (2*\xOff,0) -- (2*\xOff,\len);
                \node[\colA] at (2*\xOff,\nOff) {B};
            \end{scope}
        \end{tikzpicture}
    \end{center}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{scope}
                ...
                \uncover<5->{
                    \draw[red,<->] (120+\off:0.5*\len) to[bend right] (-120-\off:0.5*\len);
                }
            \end{scope}
...
\begin{frame}{Folding graph}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \def\fgC{red}
            \uncover<5->{
                \draw[\fgA,<->] (\off:0.5*\len) to[bend right] (120-\off:0.5*\len); 
                \draw[\fgB,<->] (120+\off:0.5*\len) to[bend right] (240-\off:0.5*\len);
                \draw[\fgC,<->] (-120+\off:0.5*\len) to[bend right] (-\off:0.5*\len);
            }
            ...
            \begin{scope}[xshift=5cm]
                ...
                \uncover<6->{
                    \draw[\fgA] (Top) -- (MidLeft);
                    \draw[\fgB] (Top) -- (Mid);
                    \draw[\fgC] (Top) -- (MidRight);
                }
                \uncover<7->{
                    \draw[\fgB] (MidLeft) -- (DownLeft);
                    \draw[\fgC] (MidLeft) -- (Down);
                }
                \uncover<8->{
                    \draw[\fgA] (Mid) -- (DownLeft);
                    \draw[\fgC] (Mid) -- (DownRight);
                    \draw[\fgA] (MidRight) -- (Down);
                    \draw[\fgB] (MidRight) -- (DownRight);
                }
            \end{scope}
        \end{tikzpicture}
    \end{center}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \uncover<10->{
                \draw[\fgA,<->] ($(P1)+(180-\off:\scal*\len)$) to[bend left] ($(P1)+(\off:\scal*\len)$);
                \draw[\fgB,<->] ($(P1)+(180+\off:\scal*\len)$) to[bend right] ($(P1)+(-\off:\scal*\len)$);
                \draw[\fgC,<->] ($(P2)+(180-\off:\scal*\len)$) to[bend left] ($(P2)+(\off:\scal*\len)$);
                \draw[\fgD,<->] ($(P2)+(180+\off:\scal*\len)$) to[bend right] ($(P2)+(-\off:\scal*\len)$);
            }
            ...
            \begin{scope}[xshift=6cm]
                ...
                \uncover<13->{
                    \draw[\fgC,dashed] (B1) -- (M12);
                }

                \uncover<14->{
                    \draw[\fgB,dashed] (B3) -- (M23);
                    \draw[\fgD,dashed] (B4) -- (M45);
                    \draw[\fgA,dashed] (B6) -- (M56);
                }
            \end{scope}
        \end{tikzpicture}
    \end{center}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \begin{scope}
                ...
                \uncover<5->{
                    \draw[red,<->] (120-\off:0.5*\len) to[bend left] (\off:0.5*\len);
                }
            \end{scope}
