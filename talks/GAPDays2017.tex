...
\begin{frame}{Construction example}
    ...
    \begin{tikzpicture}
        ...
        \draw[\colA,\width,dashed] ($(Z)!0.5!(P4)$) to[bend right] ($(Z)!0.5!(P0)$);

        % 6
        \node at (barycentric cs:P2=1,P3=1,Q23=1) {6};
        \draw[\colA,\width] (P2) -- (Q23);
        \draw[\colA,\width,dashed] ($(P2)!0.5!(Q23)$) to[bend left] ($(P2)!0.5!(Q12)$);
        \draw[\colB,\width] (P3) -- (Q23);

        % 7
        \node at (barycentric cs:P3=1,P4=1,Q34=1) {7};
        \draw[\colB,\width] (P3) -- (Q34);
        \draw[\colB,\width,dashed] ($(P3)!0.5!(Q23)$) to[bend right] ($(P3)!0.5!(Q34)$);
        \draw[\colA,\width] (P4) -- (Q34);

        % 8
        \node at (barycentric cs:P0=1,P1=1,Q01=1) {8};
        \draw[\colB,\width] (P1) -- (Q01);
        \draw[\colB,\width,dashed] ($(P1)!0.5!(Q01)$) to[bend right] ($(P1)!0.5!(Q12)$);
        \draw[\colA,\width] (P0) -- (Q01);
        \draw[\colA,\width,dashed] ($(P0)!0.5!(Q01)$) to[bend left=60] ($(P4)!0.5!(Q34)$);
    \end{tikzpicture}
    \end{center}
\end{frame}
