...
\begin{frame}{Group theoretic descriptions}
    \pause
    Let $\mathcal{S}$ be a coloured simplicial surface and 
    $\sigma_a, \sigma_b, \sigma_c$ its permutations.

    \begin{itemize}
        \pause
        \item The connected components of $\mathcal{S}$ correspond to \pause 
            the orbits of $\langle \sigma_a, \sigma_b, \sigma_c\rangle$ on
            the faces
        \pause
        \item Consider the automorphism group of $\mathcal{S}$
            \begin{itemize}
                \pause
                \item subgroup of symmetric group on faces
                \pause
                \item 
            \end{itemize}
    \end{itemize}
