...
\begin{frame}{Embedding questions}
    ...
    \begin{enumerate}
        \item<6-> Only simplicial surfaces (that are built from polygons)
...
\begin{frame}{Progress report}
    ...
    \begin{itemize}
        \pause
        \item computation of colouring
        \pause
        \item construction of surfaces from colouring
        \pause
        \item drawing of simplicial surfaces
        \pause
        \item construction of coloured covering
    \end{itemize}
