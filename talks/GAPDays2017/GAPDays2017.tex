...
\begin{frame}{Summary}
    \begin{itemize}
        ...
        \item Edge colouring
            \begin{itemize}
                \pause
                \item current theory implemented
                \pause
                \item a lot of theory missing
            \end{itemize}
        \pause
        \item Abstract folding
            \begin{itemize}
                \pause
                \item framework exists
                \pause
                \item needs proper implementation
            \end{itemize}
    \end{itemize}
\end{frame}
