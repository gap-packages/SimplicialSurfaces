...
Version := "0.5",
Date := "07/07/2017", # dd/mm/yyyy format
ArchiveURL := "TODO",
ArchiveFormats := "TODO",
...
Dependencies := rec(
  GAP := ">= 4.8",
  NeededOtherPackages := [ [ "Grape", ">=4.7" ], [ "Digraphs", ">=0.5" ] ],
  SuggestedOtherPackages := [ [ "GAPDoc", ">= 1.6" ], ["AutoDoc", ">=2017.09.08"], [ "IO", ">=2.2" ], [ "NautyTracesInterface", ">0.1" ] ],
  ExternalConditions := [ ],
),
