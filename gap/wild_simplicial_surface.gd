...
DeclareAttribute( "GeneratorsAttributeOfWildSimplicialSurface", 
		IsWildSimplicialSurface );
DeclareOperation( "Generators", [IsWildSimplicialSurface] );
...
#! MrType(tetra);
#! @EndExample
DeclareAttribute( "MrTypeAttributeOfWildSimplicialSurface", 
		IsWildSimplicialSurface);
DeclareOperation( "MrType", [IsWildSimplicialSurface] );
DeclareOperation( "MRType", [IsWildSimplicialSurface] );
