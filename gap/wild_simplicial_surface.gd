...
#TODO Constructor of a mirror-labelled surface only based on generators
# How should this be named? MirroredSimplicialSurfaceByGenerators?
# How should the difference between support and domain be handled?
...
#TODO should this name be changed to GeneratorsOfWildSimplicialSurface? That seems to be the norm in other packages
