...
#! and some other improvements. To use it, just type <C>git checkout animations</C>. 
#! If you find any errors or unexpected behavior, please open an issue in the fork where the new version is being developed: <URL>https://github.com/schnellecom/SimplicialSurfaces/issues</URL></E>
#! 
