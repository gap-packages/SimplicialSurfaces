...
\draw[edge=blue] (V4_1) -- node[edgeLabel] {$3$} (V1_1);
\draw[edge=blue] (V1_1) -- node[edgeLabel] {$3$} (V4_2);
\draw[edge=blue] (V3_1) -- node[edgeLabel] {$4$} (V2_1);
\draw[edge=red] (V2_1) -- node[edgeLabel] {$5$} (V4_1);
\draw[edge=red] (V4_3) -- node[edgeLabel] {$5$} (V2_1);
\draw[edge=green] (V4_2) -- node[edgeLabel] {$6$} (V3_1);
\draw[edge=green] (V3_1) -- node[edgeLabel] {$6$} (V4_3);
