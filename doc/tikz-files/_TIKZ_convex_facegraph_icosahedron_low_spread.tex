...
\begin{tikzpicture}[vertexBall, edgeDouble=nolabels, faceStyle=nolabels, scale=4]
    ...
    \coordinate (V6) at (0.5163118946285428 , -7.765149634408886e-10);
    \coordinate (V7) at (0.1614864032665868 , -0.4460855978160754);
    \coordinate (V8) at (-0.3197938757917752 , -0.4593389774950907);
    \coordinate (V9) at (-0.5292706366829111 , 0.1424753670618677);
    \coordinate (V10) at (-0.009741685598258207 , 0.4910417935991915);
    \coordinate (V11) at (0.2412985701850865 , -0.1664845467062768);
    \coordinate (V12) at (-0.1497258880922867 , -0.3025990736622617);
    \coordinate (V13) at (-0.3151656185658844 , -0.02476406050888025);
    \coordinate (V14) at (-0.1270187743825422 , 0.2664627757024033);
    \coordinate (V15) at (0.1747098689598691 , 0.1979538832885492);
    \coordinate (V16) at (0.08113396435917979 , -0.08657118064268243);
    \coordinate (V17) at (-0.08457670923818356 , -0.1467718202157678);
    \coordinate (V18) at (-0.1944452295320299 , -0.07340624254900144);
    \coordinate (V19) at (-0.1356899517998978 , 0.1140932896727264);
    \coordinate (V20) at (0.03635327717978389 , 0.1223482232574671);
