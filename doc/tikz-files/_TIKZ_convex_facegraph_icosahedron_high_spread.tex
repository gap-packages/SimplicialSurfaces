...
\begin{tikzpicture}[vertexBall, edgeDouble=nolabels, faceStyle=nolabels, scale=4]
    ...
    \coordinate (V6) at (0.7927050976979469 , -3.327921271889523e-10);
    \coordinate (V7) at (0.2424730992248824 , -0.7390375056311521);
    \coordinate (V8) at (-0.6182970511232349 , -0.488652952881346);
    \coordinate (V9) at (-0.6555846775013854 , 0.4363679932957395);
    \coordinate (V10) at (0.2138651127700633 , 0.753907349238458);
    \coordinate (V11) at (0.6257282990590397 , -0.1221815949309928);
    \coordinate (V12) at (-0.4759335274339455 , -0.4043145436795418);
    \coordinate (V13) at (-0.5299770435427567 , 0.3239876612138216);
    \coordinate (V14) at (0.1445119225113219 , 0.6121867255933728);
    \coordinate (V15) at (0.6209603013165698 , 0.1266425475472756);
    \coordinate (V16) at (0.4597638254237214 , -0.1271779158715349);
    \coordinate (V17) at (-0.3282846657626078 , -0.2658951127485535);
    \coordinate (V18) at (-0.4273051358160279 , 0.2413450347190398);
    \coordinate (V19) at (0.1004588251932902 , 0.5013390228086395);
    \coordinate (V20) at (0.5253135731118553 , 0.1614011047413686);
