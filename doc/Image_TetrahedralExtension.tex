...
\node[faceLabel] at (barycentric cs:V3_1=1,V5_2=1,V1_1=1) {$6$};
\fill[face]  (V2_1) -- (V5_3) -- (V3_2) -- cycle;
\node[faceLabel] at (barycentric cs:V2_1=1,V5_3=1,V3_2=1) {$7$};
...
\draw[edge] (V5_1) -- node[edgeLabel] {$7$} (V1_1);
\draw[edge] (V1_1) -- node[edgeLabel] {$7$} (V5_2);
\draw[edge] (V2_1) -- node[edgeLabel] {$8$} (V5_1);
\draw[edge] (V5_3) -- node[edgeLabel] {$8$} (V2_1);
