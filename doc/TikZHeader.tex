...
\tikzset{
    vertexNodeBall/.style = {shape=circle, ball color=#1, inner sep=2pt, outer sep=0pt, minimum size=3pt, font=\tiny},
...
\tikzset{
    edgeLineDouble/.style = {very thin, double=#1, double distance=.7pt, line join=round},
