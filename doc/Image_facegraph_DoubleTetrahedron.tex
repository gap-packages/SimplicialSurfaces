...
\draw[edge] (V2) -- node[edgeLabel] {$1$} (V5);
\draw[edge] (V4) -- node[edgeLabel] {$2$} (V6);
\draw[edge] (V2) -- node[edgeLabel] {$3$} (V4);
\draw[edge] (V3) -- node[edgeLabel] {$4$} (V7);
\draw[edge] (V2) -- node[edgeLabel] {$5$} (V3);
\draw[edge] (V3) -- node[edgeLabel] {$6$} (V4);
\draw[edge] (V5) -- node[edgeLabel] {$7$} (V6);
\draw[edge] (V5) -- node[edgeLabel] {$8$} (V7);
