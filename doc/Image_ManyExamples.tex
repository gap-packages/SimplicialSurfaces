			    ...
			    \filldraw[face, line join=round] (A) -- (B) -- (C) -- cycle;
			    \filldraw[face, line join=round] (A) -- (C) -- (D) -- cycle;
			    % Now the faces in the front
			    \filldraw[face, line join=round] (A) -- (B) -- (E) -- cycle;
			    \filldraw[face, line join=round] (A) -- (E) -- (D) -- cycle;
